...
We've run into a problem with c-kit when we turn the flag
convert_function_args_to_pointers to false in the config.pkg file.
...
error if we compile it with c-kit:
