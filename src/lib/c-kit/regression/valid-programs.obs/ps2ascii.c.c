...
FILE *source;
{
  ...
  while ((ch = fgetc(source)) != (-1) )
	...
	switch(ch)
	  ...
	  case '\n' : (__us_rsthread_stdio ? __semputc((' '), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((' ')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((' ')))))  ; ; break;               
	  case '-' : if((c = fgetc(source)) == ')') {   
	               word_over_line=1 ;
		     }
	             else {
		       (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ;
		     }
	             ungetc(c, source);
	             break;
	  ...
	  case '\\' : 
	    switch(ch=fgetc(source))
	      {
	      case '(' :
	      case ')' : (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ; break;                          
	      case 't' : (__us_rsthread_stdio ? __semputc(('\t'), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf((('\t')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)(('\t')))))  ; ; break;                    
	      case '\n' : break;
	      case 'n' :   break;              
	      case '\\': (__us_rsthread_stdio ? __semputc(('"'), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf((('"')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)(('"')))))  ; ; break;                     
		...
		case '1': switch(ch=fgetc(source))
		  ...
		  default: fputs("\\01",(&__iob[1]) ); (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ;    
		  } break;                                        
		default: fputs("\\0",(&__iob[1]) ); (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ;       
		} break;
	      case '1' : case '2' : case '3' : case '4' :
	      case '5' : case '6' : case '7' : (__us_rsthread_stdio ? __semputc(('\\'), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf((('\\')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)(('\\')))))  ; ;    
	      default: (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ;
	      } break;                                
	  default: (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; ;
	  }
      else                                                  
	  ...
	  case '('  : in_paren++;                     
		...
		switch(prev_ch)   
		  ...
		  case 'q' : case 'r' : case 's' : case 't' : 
		    break;
		  case 'y' : (__us_rsthread_stdio ? __semputc(('\n'), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf((('\n')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)(('\n')))))  ; ; break;                
		  case 'b' : if (b_space) (__us_rsthread_stdio ? __semputc((' '), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((' ')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((' ')))))  ; ; break;  
		  case 'a' : case 'c' : case 'd' : case 'e' : 
		  case 'f' : case 'g' : case 'h' : case 'i' : 
		  case 'j' : case 'k' : case 'x' : (__us_rsthread_stdio ? __semputc((' '), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((' ')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((' ')))))  ; ; break;
		  default: break;
		  } 
	      }
	      else {
		(__us_rsthread_stdio ? __semputc((' '), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((' ')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((' ')))))  ; ;
	      }
	    }
	    b_space = 1;               
	    word_over_line = 0 ;
...
while ((ch=fgetc(source)) != (-1) )
  {
    switch (ch)
      ...
      else (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ;
      case '\n' : if (last==1) { puts(""); last=0; } break;
      case '('  : if (para++>0) (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; break;
      case ')'  : if (para-->1) (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; 
      else (__us_rsthread_stdio ? __semputc((' '), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((' ')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((' ')))))  ;
	last=1; break;
	...
	switch(ch=fgetc(source))
	  ...
	  case '4' :  case '5' : case '6' : case '7' :
	    (__us_rsthread_stdio ? __semputc(('\\'), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf((('\\')), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)(('\\')))))  ;
	  default:  (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ; break;
	  }
	break;
      default:	if (para>0) (__us_rsthread_stdio ? __semputc((ch), (&__iob[1])) : 			(--( (&__iob[1]))->_count < 0 ? __flsbuf(((ch)), ( (&__iob[1]))) 					  : (int)(*( (&__iob[1]))->_ptr++ = (unsigned char)((ch)))))  ;
      }
  }
}
