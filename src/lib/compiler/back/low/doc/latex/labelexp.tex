...
\begin{SML}
   generic package \mlrischref{code/labelExp.sml}{LabelExp}(late_constant : \mlrischref{src/lib/compiler/back/low/main/nextcode/late-constant.pkg}{Late_Constant})
\end{SML}
