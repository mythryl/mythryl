...
\usepackage{alltt}
   ...
   \KW{\INCLUDE}{include} \KW{\API}{api} \KW{\UNIONTYPE}{enum}
...
of the uniontypes.  However, in Standard ML, these functions
...
mundane bookkeeping of writing transformations on user defined uniontypes.  
...
\API WFF =
\BEGIN_API
   \UNIONTYPE wff = FALSE | TRUE | VAR \OF String
                | AND \OF wff * wff
                | OR \OF wff * wff
                | NOT \OF wff 
