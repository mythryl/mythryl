...
\ahrefloc{src/glu/ogl/src/easy-ogl.api}{src/glu/ogl/src/easy-ogl.api}; the {\tt Ogl\_Client} interface is defined by 
\ahrefloc{src/glu/ogl/src/ogl-client.api}{src/glu/ogl/src/ogl-client.api}.
...
The generating Mythryl script is {\tt src/glu/ogl/sh/make-ogl-glue}. 

The specification file is {\tt src/glu/ogl/etc/library-glue.plan}. 
