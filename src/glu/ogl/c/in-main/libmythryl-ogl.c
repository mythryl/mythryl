...
// is implemented by
//
//     src/glu/ogl/src/ogl-client-driver-for-library-in-main-process.pkg
//
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  write_libmythryl_xxx_c_plain_fun  per  src/glu/ogl/etc/library-glue.plan. */


/* Do not edit this or preceding lines -- they are autobuilt by make-library-glue. */


/////////////// old libmythryl-ogl.c contents follow //////////////////////////////////
...
CFUNC("type_of_next_queued_callback","type_of_next_queued_callback",	   _lib7_Ogl_type_of_next_queued_callback,	"Void -> Int")
CFUNC("get_queued_void_callback","get_queued_void_callback",	   _lib7_Ogl_get_queued_void_callback,		"Void -> Int")
CFUNC("get_queued_bool_callback","get_queued_bool_callback",	   _lib7_Ogl_get_queued_bool_callback,		"Void -> (Int, Bool)")
CFUNC("get_queued_float_callback","get_queued_float_callback",	   _lib7_Ogl_get_queued_float_callback,		"Void -> (Int, Float)")
CFUNC("get_queued_button_press_callback","get_queued_button_press_callback",  _lib7_Ogl_get_queued_button_press_callback,	"Void -> (Int, Int, Int, Float, Float, Int, Int)")  // Void -> (callback_number, widget_id, button, x, y, time, modifiers)
CFUNC("get_queued_key_press_callback","get_queued_key_press_callback",     _lib7_Ogl_get_queued_key_press_callback,	"Void -> (Int, Int, Int, Int, Int)")                // Void -> (callback_number, key, keycode, time, modifiers)
CFUNC("get_queued_motion_notify_callback","get_queued_motion_notify_callback", _lib7_Ogl_get_queued_motion_notify_callback,	"Void -> (Int, Int, Int, Float, Float, Int, Bool)") // Void -> (callback_number, widget_id, time, x, y, modifiers, is_hint)
CFUNC("get_queued_expose_callback","get_queued_expose_callback",        _lib7_Ogl_get_queued_expose_callback,	"Void -> (Int, Int, Int, Int, Int, Int, Int)")      // Void -> (callback_number, widget, count, area_x, area_y, area_wide, area_high)
CFUNC("get_queued_configure_callback","get_queued_configure_callback",     _lib7_Ogl_get_queued_configure_callback,	"Void -> (Int, Int, Int, Int, Int, Int)")           // Void -> (callback_number, widget, x,    y,    wide, high)

CFUNC("get_widget_allocation","get_widget_allocation",             _lib7_Ogl_get_widget_allocation,		"Int -> (Int, Int, Int, Int)")                      // Widget -> (x,    y,    wide, high)
CFUNC("make_dialog","make_dialog",                       _lib7_Ogl_make_dialog,			"Void -> (Int, Int, Int)")                          // Void   -> (dialog, vbox, action-area)
CFUNC("unref_object","unref_object",                      _lib7_Ogl_unref_object,			"Int -> Void")                                      // Widget -> Void
CFUNC("run_eventloop_once","run_eventloop_once",                _lib7_Ogl_run_eventloop_once,		"Bool -> Bool")                                     // Bool -> Bool
#endif
