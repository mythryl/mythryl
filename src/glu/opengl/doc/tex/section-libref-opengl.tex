...
% Do not edit this or following lines -- they are autobuilt.  (patchname='opengl-api-calls')
...
% Do not edit this or following lines -- they are autobuilt.  (patchname='opengl-call-to-mythryl-binding')
...
The specification file is {\tt src/glu/opengl/etc/construction.plan}. 
