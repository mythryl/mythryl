...
gl\_clear & glClear &  & {  session: Session,  color\_buffer: Bool, depth\_buffer: Bool } -> Void \\ \hline
glfw\_get\_window\_param & glfwGetWindowParam &  & Session -> Bool \\ \hline
glfw\_open\_window & glfwOpenWindow &  & {  session: Session,  wide: Int, high: Int,  redbits: Int, greenbits: Int, bluebits: Int,  alphabits: Int, depthbits: Int, stencilbits: Int,  fullscreen: Bool } -> Bool \\ \hline
...
% Do not edit this or following lines -- they are autobuilt by make-library-glue.
glClear & gl\_clear &  & {  session: Session,  color\_buffer: Bool, depth\_buffer: Bool } -> Void \\ \hline
glfwGetWindowParam & glfw\_get\_window\_param &  & Session -> Bool \\ \hline
glfwOpenWindow & glfw\_open\_window &  & {  session: Session,  wide: Int, high: Int,  redbits: Int, greenbits: Int, bluebits: Int,  alphabits: Int, depthbits: Int, stencilbits: Int,  fullscreen: Bool } -> Bool \\ \hline
