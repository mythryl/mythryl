...
open\_window & glfwOpenWindow &  & {  session: Session,  wide: Int, high: Int,  fullscreen: Bool } -> Bool \\ \hline
...
glfwOpenWindow & open\_window &  & {  session: Session,  wide: Int, high: Int,  fullscreen: Bool } -> Bool \\ \hline
