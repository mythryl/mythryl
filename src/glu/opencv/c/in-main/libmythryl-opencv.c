...
//     src/glu/opencv/etc/opencv-construction.plan
// via logic in
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  write_libmythryl_xxx_c_plain_fun  per  src/glu/opencv/etc/opencv-construction.plan. */
