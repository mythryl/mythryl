...
// is implemented by
//
//     src/glu/qqq/src/qqq-client-driver-for-library-in-main-process.pkg
//
// We get compiled by:
//    src/glu/qqq/c/in-main/Makefile.in
...
//     fn-type:
// drive the code-build path
//     mlb::BUILD_A ("callback-fn", build_callback_function)			# In src/glu/qqq/sh/make-qqq-glue
//  ->  build_callback_function							# In src/glu/qqq/sh/make-qqq-glue
//  ->  build_set_callback_fn_for_'libmythryl_xxx_c'				# In src/glu/qqq/sh/make-qqq-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  write_libmythryl_xxx_c_plain_fun  per  src/glu/qqq/etc/qqq-construction.plan. */
