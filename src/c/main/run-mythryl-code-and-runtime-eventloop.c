...
//     =============================================
    ...
    Val	previous_profile_index =  IN_OTHER_CODE__PROFILE_INDEX;
	...
	ASSIGN( THIS_FN_PROFILING_HOOK_REFCELL__GLOBAL, IN_RUNTIME__PROFILE_INDEX );			// Remember that from here CPU cycles are charged to the runtime.
