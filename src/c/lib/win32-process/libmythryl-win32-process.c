...
// win32 process library.
//
// Our record                Libmythryl_Win32_Process
...
//
Mythryl_Callable_C_Library	    Libmythryl_Win32_Process = {						// Mythryl_Callable_C_Library		def in    src/c/h/mythryl-callable-c-libraries.h
    //                              ========================
    CLIB_NAME,
    CLIB_VERSION,
    CLIB_DATE,
