...
CFUNC("find_first_file","find_first_file",      _lib7_win32_FS_find_first_file,      "String->(unt1*String option)")
CFUNC("find_next_file","find_next_file",      _lib7_win32_FS_find_next_file,     "unt1->(String option)")
CFUNC("find_close","find_close",      _lib7_win32_FS_find_close,     "unt1->Bool")
...
CFUNC("get_file_attributes","get_file_attributes",      _lib7_win32_FS_get_file_attributes,     "String->(unt1 option)")
CFUNC("get_file_attributes_by_handle","get_file_attributes_by_handle",      _lib7_win32_FS_get_file_attributes_by_handle,     "unt1->(unt1 option)")
CFUNC("get_full_path_name","get_full_path_name",      _lib7_win32_FS_get_full_path_name,     "String->String")
CFUNC("get_file_size","get_file_size",      _lib7_win32_FS_get_file_size,     "unt1->(unt1*word32)")
CFUNC("get_low_file_size","get_low_file_size",      _lib7_win32_FS_get_low_file_size,     "unt1->(unt1 option)")
CFUNC("get_low_file_size_by_name","get_low_file_size_by_name",      _lib7_win32_FS_get_low_file_size_by_name,     "String->(unt1 option)")
