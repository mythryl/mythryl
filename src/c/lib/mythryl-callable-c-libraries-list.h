...
MYTHRYL_CALLABLE_C_LIBRARY( Libmythryl_Posix_Process_Environment	)		// Libmythryl_Posix_Process_Environment	def in    src/c/lib/posix-procenv/libmythryl-posix-process-environment.c
