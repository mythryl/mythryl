...
typedef char *sockoptval_t;	// The pointer type used to pass values to getsockopt/setsockopt.

#    define BSD_COMP		// Needed to include FION* in ioctl.h

#  else
typedef void *sockoptval_t;	// The pointer type used to pass values to  getsockopt/setsockopt.
#  endif
...
// XXX BUGGO FIXME: The following includes are not needed in every file, yet they
...
#define MAX_SOCK_ADDR_BYTESIZE	1024
