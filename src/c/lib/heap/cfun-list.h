...
CFUNC("unpickle_datastructure","unpickle_datastructure",_lib7_runtime_unpickle_datastructure,		"vector_of_one_byte_unts.Vector -> X")
CFUNC("pickle_datastructure","pickle_datastructure",	_lib7_runtime_pickle_datastructure,	"X -> vector_of_one_byte_unts.Vector")
...
CFUNC("allocate_codechunk","allocate_codechunk",		_lib7_runtime_allocate_codechunk,	"Int -> rw_vector_of_one_byte_unts::Rw_Vector")
CFUNC("make_codechunk_executable","make_codechunk_executable",			_lib7_runtime_make_codechunk_executable,		"(Vector_Of_One_Byte_Unts, Int) -> Chunk -> Chunk")
CFUNC("make_package_literals_via_bytecode_interpreter","make_package_literals_via_bytecode_interpreter",		_lib7_runtime_make_package_literals_via_bytecode_interpreter,	"vector_of_one_byte_unts::Vector -> Ovec")
