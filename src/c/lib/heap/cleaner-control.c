...
static void   clean_i_agegroups   (
    ...
    clean_heap_with_extra_roots( task, age, next, NULL );				// clean_heap_with_extra_roots		def in   src/c/cleaner/call-cleaner.c
}
...
static void   clean_all_agegroups   (
    ...
    //
  clean_heap_with_extra_roots(   task,							// clean_heap_with_extra_roots		def in   src/c/cleaner/call-cleaner.c
