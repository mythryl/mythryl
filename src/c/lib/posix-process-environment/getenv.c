...
Val   _lib7_P_ProcEnv_getenv   (Task* task,  Val arg)   {
    ...
    Val s = make_ascii_string_from_c_string__may_heapclean( task, status);			// make_ascii_string_from_c_string__may_heapclean	def in    src/c/heapcleaner/make-strings-and-vectors-etc.c
