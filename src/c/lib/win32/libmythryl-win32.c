...
#include "cfun-list.h"											// Actual function list is in   src/c/lib/win32/cfun-list.h
	CFUNC_NULL_BIND
    };
#undef CFUNC
...
//
Mythryl_Callable_C_Library	    Libmythryl_Win32 = {							// Mythryl_Callable_C_Library		def in    src/c/h/mythryl-callable-c-libraries.h
    //                              ================
    CLIB_NAME,
    CLIB_VERSION,
    CLIB_DATE,
