...
CFUNC("read","read",       _lib7_P_IO_read,      "(Int, Int) -> unt8_vector::Vector")
CFUNC("readbuf","readbuf",    _lib7_P_IO_readbuf,   "(Int, rw_unt8_vector::Rw_Vector, Int) -> Int")
CFUNC("write","write",      _lib7_P_IO_write,     "(Int, unt8_vector::Vector, Int) -> Int")
CFUNC("writebuf","writebuf",   _lib7_P_IO_writebuf,  "(Int, rw_unt8_vector::Rw_Vector, Int, Int -> Int")
