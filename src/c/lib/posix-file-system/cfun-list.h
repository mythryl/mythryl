...
//     src/c/lib/posix-file-system/cfun-proto-list.h
//
...
CFUNC("mkstemp","mkstemp",   _lib7_P_FileSys_mkstemp,  "Void -> Int")
...
CFUNC("ftruncate_64","ftruncate_64",_lib7_P_FileSys_ftruncate_64,"int * word2 * one_word_unt -> Void")
