...
Val   _lib7_P_FileSys_stat_64   (Task* task,  Val arg)   {		//  : String -> statrep
	...
	RELEASE_MYTHRYL_HEAP( task->pthread, "_lib7_P_FileSys_stat_64", NULL );
	    //
...
Val   _lib7_P_FileSys_fstat_64   (Task* task,  Val arg)   {	//  : Unt -> statrep
    ...
    RELEASE_MYTHRYL_HEAP( task->pthread, "_lib7_P_FileSys_fstat_64", NULL );
	//
	status = fstat(fd, &buf);
	//
...
Val   _lib7_P_FileSys_lstat_64   (Task* task,  Val arg)   {	//  : String -> statrep
	...
	RELEASE_MYTHRYL_HEAP( task->pthread, "_lib7_P_FileSys_lstat_64", NULL );
	//
