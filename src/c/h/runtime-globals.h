...
extern Val*  c_roots_global[];
extern int   c_roots_count_global;

// "Current function" hook for profiling:
//
extern Val	this_fn_profiling_hook_refcell_global   [];
#define         THIS_FN_PROFILING_HOOK_REFCELL_GLOBAL   PTR_CAST( Val,  this_fn_profiling_hook_refcell_global +1 )

// Pointer to the pervasive package:
//
extern Val	pervasive_package_pickle_list_refcell_global	[];
#define		PERVASIVE_PACKAGE_PICKLE_LIST_REFCELL_GLOBAL		PTR_CAST( Val,  pervasive_package_pickle_list_refcell_global +1 )
...
//
extern Val	posix_interprocess_signal_handler_refcell_global	[];
#define		POSIX_INTERPROCESS_SIGNAL_HANDLER_REFCELL_GLOBAL	PTR_CAST( Val,  posix_interprocess_signal_handler_refcell_global + 1 )
...
//
extern Val      runtime_exception_global_id0	[];
#define         RUNTIME_EXCEPTION_GLOBAL	PTR_CAST( Val,  runtime_exception_global_id0  +1 )
//
extern Val	divide_exception_global_id0	[];
#define		DIVIDE_EXCEPTION_GLOBAL		PTR_CAST( Val,  divide_exception_global_id0   +1 )
//
extern Val	overflow_exception_global_id0	[];
#define         OVERFLOW_EXCEPTION_GLOBAL	PTR_CAST( Val,  overflow_exception_global_id0 +1 )
...
//
extern Val runtime_package_global;

#ifdef ASM_MATH
    extern Val mathvec_global;
#endif

#if defined(ASM_MATH)
    //
    extern Val ln_id_global_id0[];						// Referenced only on following line.
    #define    LN_ID_GLOBAL  PTR_CAST( Val,  ln_id_global_id0 +1)		// Referenced only in   src/c/main/construct-runtime-package.c
    //
    extern Val sqrt_id_global_id0[];						// Referenced only on following line. 
    #define    SQRT_ID_GLOBAL PTR_CAST( Val,  sqrt_id_global_id0 +1)		// Referenced only in   src/c/main/construct-runtime-package.c
...
extern Val   software_generated_periodic_events_handler_refcell_global   [];
#define      SOFTWARE_GENERATED_PERIODIC_EVENTS_HANDLER_REFCELL_GLOBAL   PTR_CAST( Val,  software_generated_periodic_events_handler_refcell_global +1 )
...
extern Val  software_generated_periodic_event_interval_refcell_global   [];
#define     SOFTWARE_GENERATED_PERIODIC_EVENT_INTERVAL_REFCELL_GLOBAL   PTR_CAST( Val,  software_generated_periodic_event_interval_refcell_global +1 )

extern Val   software_generated_periodic_events_switch_refcell_global  [];
#define      SOFTWARE_GENERATED_PERIODIC_EVENTS_SWITCH_REFCELL_GLOBAL  PTR_CAST( Val,  software_generated_periodic_events_switch_refcell_global +1)

extern Val   active_pthreads_count_refcell_global   [];
#define      ACTIVE_PTHREADS_COUNT_REFCELL_GLOBAL   PTR_CAST( Val,  active_pthreads_count_refcell_global +1 )
...
extern void   construct_runtime_package_global (Task* task);					// construct_runtime_package_global				def in    src/c/main/construct-runtime-package.c
