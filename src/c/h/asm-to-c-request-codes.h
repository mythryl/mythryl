...
#define REQUEST_ALLOCATE_FLOAT64_VECTOR	 	8
...
#define REQUEST_RESUME_SIGNAL_HANDLER		12
#define REQUEST_RETURN_FROM_SOFTWARE_GENERATED_PERIODIC_EVENT_HANDLER	13
#define REQUEST_RESUME_SOFTWARE_GENERATED_PERIODIC_EVENT_HANDLER	14
