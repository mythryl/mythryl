...
//
extern void  zero_agegroup0_overrun_tripwire_buffer( Task* task );						// zero_agegroup0_overrun_tripwire_buffer			def in   src/c/heapcleaner/heapcleaner-debug-stuff.c
extern void  check_agegroup0_overrun_tripwire_buffer( Task* task, char* caller );				// check_agegroup0_overrun_tripwire_buffer			def in   src/c/heapcleaner/heapcleaner-debug-stuff.c
extern void    log_task( Task* task );										// log_task							def in   src/c/heapcleaner/heapcleaner-debug-stuff.c
//
