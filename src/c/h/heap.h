...
extern void  log_task( Task* task, char* caller );								// log_task							def in   src/c/heapcleaner/heap-debug-stuff.c
extern void  log_gen0( Task* task, char* caller );								// log_gen0							def in   src/c/heapcleaner/heap-debug-stuff.c
//
