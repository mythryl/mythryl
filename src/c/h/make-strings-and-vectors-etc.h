...
extern Val  allocate_nonempty_wordslots_vector__may_heapclean	(Task* task,  int length_in_words, Roots* r);	// allocate_nonempty_wordslots_vector__may_heapclean		def in   src/c/heapcleaner/make-strings-and-vectors-etc.c
