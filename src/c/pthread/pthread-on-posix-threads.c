...
/**/													char     pth__cacheline_padding0[ CACHE_LINE_BYTESIZE ];
	...
	//
        int  pth__heapcleaner_state =  FALSE;							// Do NOT read or write this unless holding   pth__pthread_mode_mutex.
...
// 
//   1) Set pth__heapcleaner_state to TRUE.
