...
#define HAVE_LSTAT_EMPTY_STRING_BUG 0
...
/* Define to 1 if you have the <libdis.h> header file. */
#define HAVE_LIBDIS_H 1
    //
    ...
    //
    // Having HAVE_LIBDIS_H undefined is perfectly safe
    // if your system does not have libdisasm;  it just
    // means that if Mythryl segfaults and dumps the heap
    // to disk, the dump will not include disassembly of the
    // compiled Mythryl code loaded into the Mythryl heap.
...
#define PACKAGE_BUGREPORT "bug@mythryl.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "mythryl"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "mythryl 110.58"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mythryl"

/* Define to the version of this package. */
#define PACKAGE_VERSION "110.58"
