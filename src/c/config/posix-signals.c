...
//
// The '#define name' will be that visible at the C level.
//
// The 'Mythryl' name will be that visible at the Mythryl level via
// mythryl_callable_c_library_interfacefind_system_constant() --
...
// Hrm, uncommenting this currently yields
//      process-mythryl-primordial-library.pkg:   Reading          file   src/lib/core/init/init.cmi
//    
