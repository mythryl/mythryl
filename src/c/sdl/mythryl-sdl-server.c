// mythryl-sdl-server.c -- a simple Sdl subprocess server for Mythryl.
...
static void   moan_and_die   (void)   {
    //        ============
    //
    printf( "src/c/sdl/mythryl-sdl-server.c:  Fatal error:  %s  exit(1)ing.\n", text_buf );
...
open_logfile (void)
{
    ...
    sprintf (filename, "mythryl-sdl-server-%d.log~", getpid());
...
/* Above fn generated by write_mythryl_sdl_server_c_plain_fun. */
...
/* Above fn generated by write_mythryl_gtk_server_c_plain_fun. */
...
/* Above fn generated by write_gtk_server_c_set_callback_fun. */
