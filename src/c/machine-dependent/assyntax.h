...
//
//
/* $XFree86: xc/extras/Mesa/src/Intel32/assyntax.h,v 1.10 2002/03/05 20:27:24 dawes Exp $ */
...
#define AND_B(a, b)	CHOICE(bitwise_and ARG2(a,b), bitwise_and ARG2(a,b), bitwise_and ARG2(b,a))
#define ARPL(a,b)	CHOICE(arpl ARG2(a,b), arpl ARG2(a,b), arpl ARG2(b,a))
#define NAMED_L(a, b)	CHOICE(boundl ARG2(a,b), boundl ARG2(b,a), _LTOG bound ARG2(b,a))
#define NAMED_W(a, b)	CHOICE(boundw ARG2(a,b), boundw ARG2(b,a), _WTOG bound ARG2(b,a))
...
#define OR_B(a,b)	CHOICE(bitwise_or ARG2(a,b), bitwise_or ARG2(a,b), bitwise_or ARG2(b,a))
...
#define XOR_B(a, b)	CHOICE(bitwise_xor ARG2(a,b), bitwise_xor ARG2(a,b), bitwise_xor ARG2(b,a))
...
SECTION _TEXT public align=16 ilk=CODE use32 flat
SECTION _DATA public align=16 ilk=DATA use32 flat
...
#define NAMED_L(a, b)		bound L_(b), L_(a)
#define NAMED_W(a, b)		bound W_(b), W_(a)
...
#define FYL2XP1			fyl2xp1
	...
	/****************************************/
	/*					*/
	/*	Extensions to intel32 instruction set -	*/
	/*	MMX, 3DNow!			*/
	/*					*/
	/****************************************/
