...
#include "task-and-hostthread-struct-field-offsets--autogenerated.h"	// This file is autogenerated.
...
ENTRY(call_heapcleaner_asm)
	set	REQUEST_HEAPCLEANING,TMPREG3

	// FALL THROUGH

set_request:
	ld	[%sp+TASK_OFFSET],TMPREG2						// Get Task* from stack.
	ld	[TMPREG2+hostthread_byte_offset_in_task_struct],TMPREG1			// TMPREG1 := hostthread
	st	%g0,[TMPREG1+executing_mythryl_code_byte_offset_in_hostthread_struct]	// Note that we have left Mythryl code.
...
ENTRY(asm_run_mythryl_task)
	...
	ld	[ Task +                 hostthread_byte_offset_in_task_struct ], hostthreadPtr				// TMPREG4 := hostthreadPtr
	set	1,TMPREG2												// Note that we have entered Mythryl code.
	st	TMPREG2,[ hostthreadPtr +       executing_mythryl_code_byte_offset_in_hostthread_struct]
	ld	[         hostthreadPtr + all_posix_signals_seen_count_byte_offset_in_hostthread_struct],TMPREG2		// Check for pending signals.
	ld	[         hostthreadPtr + all_posix_signals_done_count_byte_offset_in_hostthread_struct],TMPREG3
	subcc	TMPREG2,TMPREG3,%g0
	bne	pending_sigs
	nop
CSYM(run_mythryl_code):					// Invoke the Mythryl code.
	jmp	PROGRAM_COUNTER
