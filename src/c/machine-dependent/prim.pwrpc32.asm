...
#include "task-and-hostthread-struct-field-offsets--autogenerated.h"	// This file is generated.
...
set_request:
	...
	lwz	atmp2,hostthread_byte_offset_in_task_struct(atmp3)	// atmp2 := Hostthread
	li	r0,0
	stw	r0,executing_mythryl_code_byte_offset_in_hostthread_struct(atmp2)		// Note that we have left Mythryl.
...
CENTRY(asm_run_mythryl_task)
	...
	lwz	atmp2,hostthread_byte_offset_in_task_struct(atmp1)				// atmp2 := Hostthread
	li	atmp3,1
	stw	atmp3,executing_mythryl_code_byte_offset_in_hostthread_struct(atmp2)         // We are entering Mythryl code.
	...
	//
	lwz	atmp1,all_posix_signals_seen_count_byte_offset_in_hostthread_struct(atmp2)	  // Number of signals received.
	lwz	atmp3,all_posix_signals_done_count_byte_offset_in_hostthread_struct(atmp2)	  // Number of signals handled.
	cmp	CR0,atmp1,atmp3
	bne	pending_sigs								  // If not equal, then pending signals.


ENTRY(run_mythryl_code) 
