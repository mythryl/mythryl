...
// and by                              pth__acquire_pthread     in   src/c/pthread/pthread-on-posix-threads.c
// and by                              pth__acquire_pthread     in   src/c/pthread/pthread-on-sgi.c
// and by                              pth__acquire_pthread     int  src/c/pthread/pthread-on-solaris.c
//
