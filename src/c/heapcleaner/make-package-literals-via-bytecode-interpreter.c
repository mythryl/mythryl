...
//
#define RETURN_LITERALS		0xff							// Generated by put_return	in    src/lib/compiler/back/top/main/make-nextcode-literals-bytecode-vector.pkg
...
if (tripwirebuf[0] != 0) log_if("luptop TRIPWIRE BUFFER TRASHED!");
	...
	case RETURN_LITERALS:													// Return the linklist of constructed literals.
	    ASSERT(pc == bytecode_vector_bytesize);
