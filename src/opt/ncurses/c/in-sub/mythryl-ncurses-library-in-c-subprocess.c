...
//                                                              # from src/opt/ncurses/sh/make-ncurses-glue
// 
// Paragraphs like
//     build-a: callback-fn
//     fn-name:
...
//       ->  build_set_callback_fn_for_'mythryl_xxx_library_in_c_subprocess_c'	# In src/opt/ncurses/sh/make-ncurses-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  build_plain_fun_for_'mythryl_xxx_library_in_c_subprocess_c'  per  src/opt/ncurses/etc/ncurses-construction.plan. */
