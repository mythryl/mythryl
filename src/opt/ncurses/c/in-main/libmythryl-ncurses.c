...
// is implemented by
//
//     src/opt/ncurses/src/ncurses-client-driver-for-library-in-main-process.pkg
//
// We get compiled by:
//    src/opt/ncurses/c/in-main/Makefile.in
...
//     fn-type:
// drive the code-build path
//     mlb::BUILD_A ("callback-fn", build_callback_function)			# In src/opt/ncurses/sh/make-ncurses-glue
//  ->  build_callback_function							# In src/opt/ncurses/sh/make-ncurses-glue
//  ->  build_set_callback_fn_for_'libmythryl_xxx_c'				# In src/opt/ncurses/sh/make-ncurses-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  write_libmythryl_xxx_c_plain_fun  per  src/opt/ncurses/etc/ncurses-construction.plan. */
