...
//
//     src/opt/opencv/src/opencv-client.api
...
//                                                              # from src/opt/opencv/sh/make-opencv-glue
// 
// Paragraphs like
//     build-a: callback-fn
//     fn-name:
...
//       ->  build_set_callback_fn_for_'mythryl_xxx_library_in_c_subprocess_c'	# In src/opt/opencv/sh/make-opencv-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  build_plain_fun_for_'mythryl_xxx_library_in_c_subprocess_c'  per  src/opt/opencv/etc/opencv-construction.plan. */
