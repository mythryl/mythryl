...
\item To provide Mythryl levels of type safety, enum uniontypes 
...
\ahrefloc{src/opt/gtk/src/easy-gtk.api}{src/opt/gtk//src/easy-gtk.api}; the {\tt Gtk} interface is defined by 
\ahrefloc{src/opt/gtk/src/gtk-client.api}{src/opt/gtk/src/gtk-client.api}.
...
The generating Mythryl script is {\tt src/opt/gtk/sh/make-gtk-glue}. 

The specification file is {\tt src/opt/gtk/etc/gtk-construction.plan}. 
...
A typical {\tt gtk-construction.plan} paragraph looks like 
...
\item {\bf gtk-code} gives the actual C call to be made to the Gtk library. 
                ...
                code, typically to translate from a Mythryl enum uniontype like 
