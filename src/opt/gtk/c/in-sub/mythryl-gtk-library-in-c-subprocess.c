...
static void   moan_and_die   (void)   {
    //        ============
    //
    printf( "src/opt/gtk/c/in-sub/mythryl-gtk-library-in-c-subprocess.c:  Fatal error:  %s  exit(1)ing.\n", text_buf );
...
//                                                              # from src/opt/gtk/sh/make-gtk-glue
// 
// Paragraphs like
//     build-a: callback-fn
//     fn-name:
...
//     lowtype:
// drive the code-build path
//   mlb::BUILD_A ("callback-fn", build_callback_function)			# In src/opt/gtk/sh/make-gtk-glue
//   ->  build_callback_function						# In src/opt/gtk/sh/make-gtk-glue
//       ->  build_set_callback_fn_for_'mythryl_xxx_library_in_c_subprocess_c'	# In src/opt/gtk/sh/make-gtk-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  build_plain_fun_for_'mythryl_xxx_library_in_c_subprocess_c'  per  src/opt/gtk/etc/gtk-construction.plan. */
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  build_set_callback_fn_for_'mythryl_xxx_library_in_c_subprocess_c'  per  src/opt/gtk/etc/gtk-construction.plan.*/
...
init  (void)
{
    ...
    */
    ...
    set_trie( trie, "make_menu",                                  do__make_menu                                 );
    set_trie( trie, "make_option_menu",                           do__make_option_menu                          );
    set_trie( trie, "make_menu_bar",                              do__make_menu_bar                             );
    set_trie( trie, "make_combo_box",                             do__make_combo_box                            );
    set_trie( trie, "make_text_combo_box",                        do__make_text_combo_box                       );
    set_trie( trie, "make_frame",                                 do__make_frame                                );
    set_trie( trie, "make_button",                                do__make_button                               );
    set_trie( trie, "make_button_with_label",                     do__make_button_with_label                    );
    set_trie( trie, "make_button_with_mnemonic",                  do__make_button_with_mnemonic                 );
    set_trie( trie, "make_toggle_button",                         do__make_toggle_button                        );
    set_trie( trie, "make_toggle_button_with_label",              do__make_toggle_button_with_label             );
    set_trie( trie, "make_toggle_button_with_mnemonic",           do__make_toggle_button_with_mnemonic          );
    set_trie( trie, "make_check_button",                          do__make_check_button                         );
    set_trie( trie, "make_check_button_with_label",               do__make_check_button_with_label              );
    set_trie( trie, "make_check_button_with_mnemonic",            do__make_check_button_with_mnemonic           );
    set_trie( trie, "make_menu_item",                             do__make_menu_item                            );
    set_trie( trie, "make_menu_item_with_label",                  do__make_menu_item_with_label                 );
    set_trie( trie, "make_menu_item_with_mnemonic",               do__make_menu_item_with_mnemonic              );
    set_trie( trie, "make_first_radio_button",                    do__make_first_radio_button                   );
    set_trie( trie, "make_next_radio_button",                     do__make_next_radio_button                    );
    set_trie( trie, "make_first_radio_button_with_label",         do__make_first_radio_button_with_label        );
    set_trie( trie, "make_next_radio_button_with_label",          do__make_next_radio_button_with_label         );
    set_trie( trie, "make_first_radio_button_with_mnemonic",      do__make_first_radio_button_with_mnemonic     );
    set_trie( trie, "make_next_radio_button_with_mnemonic",       do__make_next_radio_button_with_mnemonic      );
    set_trie( trie, "make_arrow",                                 do__make_arrow                                );
    set_trie( trie, "set_arrow",                                  do__set_arrow                                 );
    set_trie( trie, "make_horizontal_box",                        do__make_horizontal_box                       );
    set_trie( trie, "make_vertical_box",                          do__make_vertical_box                         );
    set_trie( trie, "make_horizontal_button_box",                 do__make_horizontal_button_box                );
    set_trie( trie, "make_vertical_button_box",                   do__make_vertical_button_box                  );
    set_trie( trie, "make_table",                                 do__make_table                                );
    set_trie( trie, "make_event_box",                             do__make_event_box                            );
    set_trie( trie, "make_image_from_file",                       do__make_image_from_file                      );
    set_trie( trie, "make_horizontal_separator",                  do__make_horizontal_separator                 );
    set_trie( trie, "make_vertical_separator",                    do__make_vertical_separator                   );
    set_trie( trie, "make_layout_container",                      do__make_layout_container                     );
    set_trie( trie, "layout_put",                                 do__layout_put                                );
    set_trie( trie, "layout_move",                                do__layout_move                               );
    set_trie( trie, "make_fixed_container",                       do__make_fixed_container                      );
    set_trie( trie, "fixed_put",                                  do__fixed_put                                 );
    set_trie( trie, "fixed_move",                                 do__fixed_move                                );
    set_trie( trie, "make_adjustment",                            do__make_adjustment                           );
    set_trie( trie, "make_viewport",                              do__make_viewport                             );
    set_trie( trie, "make_scrolled_window",                       do__make_scrolled_window                      );
    set_trie( trie, "make_horizontal_ruler",                      do__make_horizontal_ruler                     );
    set_trie( trie, "make_vertical_ruler",                        do__make_vertical_ruler                       );
    set_trie( trie, "make_vertical_scrollbar",                    do__make_vertical_scrollbar                   );
    set_trie( trie, "make_horizontal_scrollbar",                  do__make_horizontal_scrollbar                 );
    set_trie( trie, "make_vertical_scale",                        do__make_vertical_scale                       );
    set_trie( trie, "make_horizontal_scale",                      do__make_horizontal_scale                     );
    set_trie( trie, "make_vertical_scale_with_range",             do__make_vertical_scale_with_range            );
    set_trie( trie, "make_horizontal_scale_with_range",           do__make_horizontal_scale_with_range          );
    set_trie( trie, "make_drawing_area",                          do__make_drawing_area                         );
    set_trie( trie, "make_pixmap",                                do__make_pixmap                               );
    set_trie( trie, "make_status_bar",                            do__make_status_bar                           );
    set_trie( trie, "push_text_on_status_bar",                    do__push_text_on_status_bar                   );
    set_trie( trie, "pop_text_off_status_bar",                    do__pop_text_off_status_bar                   );
    set_trie( trie, "remove_text_from_status_bar",                do__remove_text_from_status_bar               );
    set_trie( trie, "pack_box",                                   do__pack_box                                  );
    set_trie( trie, "menu_shell_append",                          do__menu_shell_append                         );
    set_trie( trie, "menu_bar_append",                            do__menu_bar_append                           );
    set_trie( trie, "append_text_to_combo_box",                   do__append_text_to_combo_box                  );
    set_trie( trie, "set_option_menu_menu",                       do__set_option_menu_menu                      );
    set_trie( trie, "set_text_tooltip_on_widget",                 do__set_text_tooltip_on_widget                );
    set_trie( trie, "set_ruler_metric",                           do__set_ruler_metric                          );
    set_trie( trie, "set_ruler_range",                            do__set_ruler_range                           );
    set_trie( trie, "set_scrollbar_policy",                       do__set_scrollbar_policy                      );
    set_trie( trie, "draw_rectangle",                             do__draw_rectangle                            );
    set_trie( trie, "draw_drawable",                              do__draw_drawable                             );
    set_trie( trie, "queue_redraw",                               do__queue_redraw                              );
    set_trie( trie, "press_button",                               do__press_button                              );
    set_trie( trie, "release_button",                             do__release_button                            );
    set_trie( trie, "click_button",                               do__click_button                              );
    set_trie( trie, "enter_button",                               do__enter_button                              );
    set_trie( trie, "leave_button",                               do__leave_button                              );
    set_trie( trie, "show_widget",                                do__show_widget                               );
    set_trie( trie, "show_widget_tree",                           do__show_widget_tree                          );
    set_trie( trie, "destroy_widget",                             do__destroy_widget                            );
    set_trie( trie, "emit_changed_signal",                        do__emit_changed_signal                       );
    set_trie( trie, "pop_up_combo_box",                           do__pop_up_combo_box                          );
    set_trie( trie, "pop_down_combo_box",                         do__pop_down_combo_box                        );
    set_trie( trie, "set_combo_box_title",                        do__set_combo_box_title                       );
    set_trie( trie, "set_window_title",                           do__set_window_title                          );
    set_trie( trie, "set_window_default_size",                    do__set_window_default_size                   );
    set_trie( trie, "set_minimum_widget_size",                    do__set_minimum_widget_size                   );
    set_trie( trie, "set_border_width",                           do__set_border_width                          );
    set_trie( trie, "set_event_box_visibility",                   do__set_event_box_visibility                  );
    set_trie( trie, "set_widget_alignment",                       do__set_widget_alignment                      );
    set_trie( trie, "set_widget_events",                          do__set_widget_events                         );
    set_trie( trie, "set_widget_name",                            do__set_widget_name                           );
    set_trie( trie, "set_label_justification",                    do__set_label_justification                   );
    set_trie( trie, "set_label_line_wrapping",                    do__set_label_line_wrapping                   );
    set_trie( trie, "set_label_underlines",                       do__set_label_underlines                      );
    set_trie( trie, "set_scale_value_position",                   do__set_scale_value_position                  );
    set_trie( trie, "set_draw_scale_value",                       do__set_draw_scale_value                      );
    set_trie( trie, "get_scale_value_digits_shown",               do__get_scale_value_digits_shown              );
    set_trie( trie, "set_scale_value_digits_shown",               do__set_scale_value_digits_shown              );
    set_trie( trie, "set_range_update_policy",                    do__set_range_update_policy                   );
    set_trie( trie, "get_toggle_button_state",                    do__get_toggle_button_state                   );
    set_trie( trie, "set_toggle_button_state",                    do__set_toggle_button_state                   );
    set_trie( trie, "get_adjustment_value",                       do__get_adjustment_value                      );
    set_trie( trie, "set_adjustment_value",                       do__set_adjustment_value                      );
    set_trie( trie, "get_white_graphics_context",                 do__get_white_graphics_context                );
    set_trie( trie, "get_black_graphics_context",                 do__get_black_graphics_context                );
    set_trie( trie, "get_current_foreground_graphics_context",    do__get_current_foreground_graphics_context   );
    set_trie( trie, "get_current_background_graphics_context",    do__get_current_background_graphics_context   );
    set_trie( trie, "get_widget_window",                          do__get_widget_window                         );
    set_trie( trie, "add_kid",                                    do__add_kid                                   );
    set_trie( trie, "add_scrolled_window_kid",                    do__add_scrolled_window_kid                   );
    set_trie( trie, "add_table_kid",                              do__add_table_kid                             );
    set_trie( trie, "add_table_kid2",                             do__add_table_kid2                            );
    set_trie( trie, "get_viewport_vertical_adjustment",           do__get_viewport_vertical_adjustment          );
    set_trie( trie, "get_viewport_horizontal_adjustment",         do__get_viewport_horizontal_adjustment        );
    set_trie( trie, "set_table_row_spacing",                      do__set_table_row_spacing                     );
    set_trie( trie, "set_table_col_spacing",                      do__set_table_col_spacing                     );
    set_trie( trie, "set_table_row_spacings",                     do__set_table_row_spacings                    );
    set_trie( trie, "set_table_col_spacings",                     do__set_table_col_spacings                    );
    set_trie( trie, "set_clicked_callback",                       do__set_clicked_callback                      );
    set_trie( trie, "set_pressed_callback",                       do__set_pressed_callback                      );
    set_trie( trie, "set_release_callback",                       do__set_release_callback                      );
    set_trie( trie, "set_enter_callback",                         do__set_enter_callback                        );
    set_trie( trie, "set_leave_callback",                         do__set_leave_callback                        );
    set_trie( trie, "set_activate_callback",                      do__set_activate_callback                     );
    set_trie( trie, "set_destroy_callback",                       do__set_destroy_callback                      );
    set_trie( trie, "set_realize_callback",                       do__set_realize_callback                      );
    set_trie( trie, "set_button_press_event_callback",            do__set_button_press_event_callback           );
    set_trie( trie, "set_button_release_event_callback",          do__set_button_release_event_callback         );
    set_trie( trie, "set_scroll_event_callback",                  do__set_scroll_event_callback                 );
    set_trie( trie, "set_motion_notify_event_callback",           do__set_motion_notify_event_callback          );
    set_trie( trie, "set_delete_event_callback",                  do__set_delete_event_callback                 );
    set_trie( trie, "set_expose_event_callback",                  do__set_expose_event_callback                 );
    set_trie( trie, "set_key_press_event_callback",               do__set_key_press_event_callback              );
    set_trie( trie, "set_key_release_event_callback",             do__set_key_release_event_callback            );
    set_trie( trie, "set_enter_notify_event_callback",            do__set_enter_notify_event_callback           );
    set_trie( trie, "set_leave_notify_event_callback",            do__set_leave_notify_event_callback           );
    set_trie( trie, "set_configure_event_callback",               do__set_configure_event_callback              );
    set_trie( trie, "set_focus_in_event_callback",                do__set_focus_in_event_callback               );
    set_trie( trie, "set_focus_out_event_callback",               do__set_focus_out_event_callback              );
    set_trie( trie, "set_map_event_callback",                     do__set_map_event_callback                    );
    set_trie( trie, "set_unmap_event_callback",                   do__set_unmap_event_callback                  );
    set_trie( trie, "set_property_notify_event_callback",         do__set_property_notify_event_callback        );
    set_trie( trie, "set_selection_clear_event_callback",         do__set_selection_clear_event_callback        );
    set_trie( trie, "set_selection_request_event_callback",       do__set_selection_request_event_callback      );
    set_trie( trie, "set_selection_notify_event_callback",        do__set_selection_notify_event_callback       );
    set_trie( trie, "set_proximity_in_event_callback",            do__set_proximity_in_event_callback           );
    set_trie( trie, "set_proximity_out_event_callback",           do__set_proximity_out_event_callback          );
    set_trie( trie, "set_client_event_callback",                  do__set_client_event_callback                 );
    set_trie( trie, "set_no_expose_event_callback",               do__set_no_expose_event_callback              );
