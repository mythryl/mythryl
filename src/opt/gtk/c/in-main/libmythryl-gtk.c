...
// is implemented by
//
//     src/opt/gtk/src/gtk-client-driver-for-library-in-main-process.pkg
//
//
// We get compiled by:
...
//       ->  build_set_callback_fn_for_'libmythryl_xxx_c'			# In src/opt/gtk/sh/make-gtk-glue
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  write_libmythryl_xxx_c_plain_fun  per  src/opt/gtk/etc/gtk-construction.plan. */
...
/* Above fn built by src/lib/make-library-glue/make-library-glue.pkg:  build_set_callback_fn_for_'libmythryl_xxx_c'  per  src/opt/gtk/etc/gtk-construction.plan.*/
