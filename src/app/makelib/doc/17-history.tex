...
Although its programming model is more general, makelib's implementation is
...
``makelib''~\cite{blume95:cm}, while earlier ones were known as IRM ({\it
Incremental Recompilation Manager})~\cite{harper94:irm} and SC (for
{\it Separate Compilation})~\cite{harper-lee-pfenning-rollins-CM}.  makelib
...
the current implementation of makelib is integrated into the main compiler
