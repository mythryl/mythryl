...
An Mythryl-Lex specification has the general format:
...
order of decreasing precedence (from the most tightly naming operators
to the most weakly naming):
 ...
 pkg
   ...
   fun parse stream =
    let
      ...
      lexer = make_lexer (fn n => read_line stream)
      nexttok = REF (lexer())
      advance = fn () => (nexttok := lexer(); *nexttok)
      error = fn () => (say ("calc: syntax error on line" +
