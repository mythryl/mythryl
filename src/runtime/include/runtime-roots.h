 ...
 * Lib7 state vector.  Note that the name "roots" is slightly misleading;
 ...
 * bit in the register mask is set (see fps/generic.sml).  N_ARG_REGS
 * gives the number of such entries. The pc, exncont, current_thread_ptr, and baseptr
...
#   define NROOTS		18		/* GPR[0-14], PC, exnPtr, current_thread_ptr */
#   define N_ARG_REGS		15		/* GPR[0-14] */
#   define PC_INDEX		15
#   define EXN_INDEX		16		/* exnPtr */
#   define ARG_INDEX		0		/* GPR[0] */
#   define CONT_INDEX		1		/* GPR[1] */
#   define CLOSURE_INDEX	2		/* GPR[2] */
#   define LINK_INDEX	 	3		/* GPR[3] */
#   define CURRENT_THREAD_INDEX	17		/* current_thread_ptr */
