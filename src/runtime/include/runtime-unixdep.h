 ...
 *
 * See the file "machine-dependent/signal-sysdep.h" for machine
 ...
 *
 *   HAS_POSIX_LIBRARIES	if the Lib7 Posix binding is supported.
...
#  define HAS_UCONTEXT
#  define HAS_STRERROR
#  define __USE_GNU      /* XXX BUGGO FIXME we've no business doing this, and it generates error messages. */
