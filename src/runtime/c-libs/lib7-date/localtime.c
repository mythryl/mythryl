...
/* _lib7_Date_localtime : int32::Int -> (Int, Int, Int, Int, Int, Int, Int, Int, Int)
 *
 ...
 */
lib7_val_t _lib7_Date_localtime (lib7_state_t *lib7_state, lib7_val_t arg)
{
    ...
    if (tm == NULL) RAISE_SYSERR(lib7_state,0);
