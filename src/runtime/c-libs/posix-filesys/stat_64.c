...
static lib7_val_t mkStatRep (lib7_state_t *lib7_state, struct stat *buf)
{
    ...
    if (sizeof(buf->st_size)>4) {
      WORD_ALLOC (lib7_state, szhi, (Word_t)(buf->st_size >> 32));
    } else {
      WORD_ALLOC (lib7_state, szhi, (Word_t)0);
    }
    WORD_ALLOC (lib7_state, szlo, (Word_t)(buf->st_size));
  ...
  /* allocate the stat record */
    LIB7_AllocWrite(lib7_state,  0, MAKE_DESC(12, DTAG_record));
    ...
    LIB7_AllocWrite(lib7_state,  8, szhi);
    LIB7_AllocWrite(lib7_state,  9, szlo);
    LIB7_AllocWrite(lib7_state, 10, atime);
    LIB7_AllocWrite(lib7_state, 11, mtime);
    LIB7_AllocWrite(lib7_state, 12, ctime);
 ...
 */
lib7_val_t _lib7_P_FileSys_stat_64 (lib7_state_t *lib7_state, lib7_val_t arg)
{
...
} /* end of _lib7_P_FileSys_stat_64 */

/* _lib7_P_FileSys_fstat_64 : word -> statrep
 *
 * Query file status given file descriptor.
 */
lib7_val_t _lib7_P_FileSys_fstat_64 (lib7_state_t *lib7_state, lib7_val_t arg)
{
...
} /* end of _lib7_P_FileSys_fstat_64 */

/* _lib7_P_FileSys_lstat_64 : String -> statrep
 *
 * Query file status given file name, but do not follow
 * symbolic links.
 */
lib7_val_t _lib7_P_FileSys_lstat_64 (lib7_state_t *lib7_state, lib7_val_t arg)
{
    char            *path = STR_LIB7toC(arg);
    int		    status;
    struct stat     buf;
...
} /* end of _lib7_P_FileSys_lstat_64 */
