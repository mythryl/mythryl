...
some datatype, consider renaming it at the point of definition, then 
...
A tutorial on cascading datatypes might be helpful.  A relatively tractable 
...
Base equality types are: 
        ...
        Void     ()   
        Bool     TRUE FALSE           # This is really a special case of datatypes, treated below. 
...
(NB: Null_Or() and List() are both in fact special-case datatype 
definitions  --- we list them separately in the interests of putting 
tutorial clarity before mathematical minimality.) 

The interesting corner cases arise from datatype definitions. 

First, datatype definitions need not reference any subtypes, 
...
Also, datatype definitions can be recursive: 
...
Most generally, however, datatype definitions may refer to 
...
As we saw earlier, a datatype declaration is used to introduce a new 
...
an extension of the datatype and recursive-val declaration forms.  We will 
...
HOW TO WRITE CODE THAT "JUST WORKS(TM)"
 ...
 o Use enumerated datatypes instead of string or int constants,
   ...
   to a datatype, the compiler will tell you about every place in the
   ...
   structured datatypes with clearer semantics.
...
'  like weeds after a spring rain.
   ...
   Use enumerated datatypes whenever reasonably possible.

   Even when you need integers, use type abstraction or datatype wrappers
