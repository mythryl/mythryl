...
The {\tt pickler\_junk} package implements the \ahrefloc{api:Pickler\_Junk}{Pickler\_Junk} api.

The {\tt pickler\_junk} package source code is in \ahrefloc{src/lib/compiler/front/semantic/pickle/pickler-junk.pkg}{src/lib/compiler/front/semantic/pickle/pickler-junk.pkg}.

See also: \ahrefloc{pkg:unpickler\_junk}{unpickler\_junk}.
