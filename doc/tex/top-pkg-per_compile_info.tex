...
The {\tt per\_compile\_info} package source code is in \ahrefloc{src/lib/compiler/front/typer-stuff/main/per-compile-info.pkg}{src/lib/compiler/front/typer-stuff/main/per-compile-info.pkg}.
