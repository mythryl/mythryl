...
The {\tt Int\_Chartype} api is implemented by the \ahrefloc{pkg:int\_chartype}{int\_chartype} package.

The {\tt Int\_Chartype} api source code is in \ahrefloc{src/lib/std/src/int-chartype.api}{src/lib/std/src/int-chartype.api}.
