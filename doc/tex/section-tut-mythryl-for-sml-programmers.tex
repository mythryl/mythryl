...
value bindings are now just {\tt x = 12;} and vanilla datatype 
...
signature My_Api = sig
    ...
    datatype Point = TWO_D of (real * real) | THREE_D of (real * real * realt)
...
structure my_package :> My_Api = struct
    datatype Color = RED | GREEN | BLUE
    datatype Point = TWO_D of (real * real) | THREE_D of (real * real * real)
...
A simple datatype declaration is now simply
...
Mythryl does not use the {\sc SML} {\tt of} particle in datatype declarations. 
