...
\ahrefloc{src/opt/qqq/src/qqq-client.api}{src/opt/qqq/src/qqq-client.api}.
...
The generating Mythryl script is {\tt src/opt/qqq/sh/make-qqq-glue}. 

The specification file is {\tt src/opt/qqq/etc/qqq-construction.plan}. 
