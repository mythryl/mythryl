...
The {\tt Disassembler\_Intel32} api is implemented by the \ahrefloc{pkg:disassembler\_intel32}{disassembler\_intel32} package.

The {\tt Disassembler\_Intel32} api source code is in \ahrefloc{src/lib/src/disassembler-intel32.api}{src/lib/src/disassembler-intel32.api}.
