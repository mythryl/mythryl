...
\ahrefloc{src/opt/ncurses/src/ncurses-client.api}{src/opt/ncurses/src/ncurses-client.api}.
...
move &  &  & { session: Session, x: Int, y: Int } -> Void \\ \hline
negate\_boolean &  &  & (Session, Bool) -> Bool \\ \hline
negate\_float &  &  & (Session, Float) -> Float \\ \hline
negate\_int &  &  & (Session, Int) -> Int \\ \hline
nl &  &  & Session -> Void \\ \hline
noecho &  &  & Session -> Void \\ \hline
nonl &  &  & Session -> Void \\ \hline
print\_hello\_world &  &  & Session -> Void \\ \hline
refresh &  &  & Session -> Void \\ \hline
start\_color &  &  & Session -> Void \\ \hline
...
The generating Mythryl script is {\tt src/opt/ncurses/sh/make-ncurses-glue}. 

The specification file is {\tt src/opt/ncurses/etc/ncurses-construction.plan}. 
