...
\begin{verbatim}
    linux$ my
    eval:  fun back__ticks string  =  string::tokens  char::is_space  string;
    eval:  `abc def`;
...
\begin{verbatim}
    linux$ my
    eval:  back__ticks  =  string::tokens  char::is_space;
    eval:  `abc def`;
...
\begin{verbatim}
    fun back__ticks string  =  match  (string::tokens char::is_space string);
\end{verbatim}
...
then a datatype with one constructor for each defaultable keyword 
...
\ahrefloc{src/glu/gtk/src/easy-gtk.pkg}{src/glu/gtk/src/easy-gtk.pkg}.
...
The very special {\bf Exception} datatype is also predefined.
...
Finally, Mythryl's datatype definition facility effectively 
...
\ahrefloc{src/lib/compiler/front/semantic/symbolmapstack/base-types-and-ops-symbolmapstack.pkg}{src/lib/compiler/front/semantic/symbolmapstack/base-types-and-ops-symbolmapstack.pkg};
...
One major exception is that every datatype declaration creates a 
new type:
...
\begin{itemize}
\item Every datatype definition introduces a new type.
...
The predefined Mythryl datatype {\tt Exception} is unique in that it may 
be incrementally extended by defining new constructors for it using 
{\tt exception} declarations.

Vanilla Mythryl datatype declarations require that all constructors belonging 
to the type be declared up front at the point of datatype definition;  no later 
extension of the datatype is allowed.  Normally this is good;  it means that 
when you read a datatype definition in the code you can be sure that what 
you see is the complete story.

But situations can occasionally arise in industrial-scale Mythryl programming in 
which it is desirable to incrementally extend a datatype.

Programmers can and do simply use the {\tt Exception} datatype directly in 
...
Here is a hack to define your own extensible datatypes separate from 
the standard Mythryl {\tt Exception} datatype:
...
type parameter;  we added the phantom type without changing the runtime datatype 
in any way.
...
datatypes to use as the phantom types, just to improve readability:
...
\ahrefloc{src/app/makelib/concurrency/makelib-thread-queen.pkg}{src/app/makelib/concurrency/makelib-thread-queen.pkg}.
...
\begin{verbatim}
    ...
    print "\n";
    printf "object::equal object_1a object_1a == %s\n" ((object::equal object_1a object_1a) ?? "TRUE" :: "FALSE");
    printf "object::equal object_1a object_1b == %s\n" ((object::equal object_1a object_1b) ?? "TRUE" :: "FALSE");
    printf "object::equal object_1b object_1b == %s\n" ((object::equal object_1b object_1b) ?? "TRUE" :: "FALSE");

    print "\n";
    printf "object::equal object_2aa object_2aa == %s\n" ((object::equal object_2aa object_2aa) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2aa object_2ab == %s\n" ((object::equal object_2aa object_2ab) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2aa object_2ba == %s\n" ((object::equal object_2aa object_2ba) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2aa object_2bb == %s\n" ((object::equal object_2aa object_2bb) ?? "TRUE" :: "FALSE");

    printf "object::equal object_2ab object_2aa == %s\n" ((object::equal object_2ab object_2aa) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ab object_2ab == %s\n" ((object::equal object_2ab object_2ab) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ab object_2ba == %s\n" ((object::equal object_2ab object_2ba) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ab object_2bb == %s\n" ((object::equal object_2ab object_2bb) ?? "TRUE" :: "FALSE");

    printf "object::equal object_2ba object_2aa == %s\n" ((object::equal object_2ba object_2aa) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ba object_2ab == %s\n" ((object::equal object_2ba object_2ab) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ba object_2ba == %s\n" ((object::equal object_2ba object_2ba) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2ba object_2bb == %s\n" ((object::equal object_2ba object_2bb) ?? "TRUE" :: "FALSE");

    printf "object::equal object_2bb object_2aa == %s\n" ((object::equal object_2bb object_2aa) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2bb object_2ab == %s\n" ((object::equal object_2bb object_2ab) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2bb object_2ba == %s\n" ((object::equal object_2bb object_2ba) ?? "TRUE" :: "FALSE");
    printf "object::equal object_2bb object_2bb == %s\n" ((object::equal object_2bb object_2bb) ?? "TRUE" :: "FALSE");
\end{verbatim}
